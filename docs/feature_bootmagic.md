...
|`MAGIC_SWAP_LCTRL_LGUI`|Swap the left Ctrl and GUI keys|
|`MAGIC_SWAP_RCTRL_RGUI`|Swap the right Ctrl and GUI keys|
...
|`MAGIC_SWAP_CONTROL_COMMAND`/`CC_SWAP`|Swap Control and GUI on both sides|
|`MAGIC_SWAP_ALT_GUI`/`AG_SWAP`|Swap Alt and Gui on both sides|
|`MAGIC_UNSWAP_CONTROL_CAPSLOCK`|Disable the Control/Capslock swap|
|`MAGIC_UNSWAP_LCTRL_LGUI`|Disable Left Ctrl and GUI switching|
|`MAGIC_UNSWAP_RCTRL_RGUI`|Disable Right Ctrl and GUI switching|
...
|`MAGIC_UNSWAP_CONTROL_COMMAND`/`CC_NORM`|Disable the Control/GUI swap|
