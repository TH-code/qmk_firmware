...
enum quantum_keycodes {
    ...
    MAGIC_SWAP_LCTRL_LGUI,
    MAGIC_SWAP_RCTRL_RGUI,
    ...
    MAGIC_HOST_NKRO,
    MAGIC_SWAP_CONTROL_COMMAND,
    MAGIC_SWAP_ALT_GUI,
    MAGIC_UNSWAP_CONTROL_CAPSLOCK,
    MAGIC_UNSWAP_LCTRL_LGUI,
    MAGIC_UNSWAP_RCTRL_RGUI,
...
#define CC_SWAP MAGIC_SWAP_CONTROL_COMMAND
#define CC_NORM MAGIC_UNSWAP_CONTROL_COMMAND
